...
export default function NewListingPage() {
  ...
  useEffect(() => {
    if (!loading && !profile) router.push('/vendor/login');
    if (!loading && profile && !SELLER_ROLES.includes(profile.role)) router.push('/vendor/register');
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      <div className="mb-6">
        <Link href="/vendor/dashboard" className="inline-flex items-center gap-2 text-sm text-maasai-brown/60 dark:text-maasai-beige/60 hover:text-maasai-red transition-colors mb-3">
