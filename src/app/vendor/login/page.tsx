...
import { Mail, Lock, Eye, EyeOff, ShieldCheck, Store } from 'lucide-react';
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-3 mb-6">
            ...
            <div className="text-left">
              ...
              <p className="text-maasai-terracotta text-sm font-medium">Vendor Portal</p>
            </div>
          </Link>
          <h1 className="text-2xl font-bold text-maasai-black dark:text-white">Vendor Sign In</h1>
          <p className="text-maasai-brown/70 dark:text-maasai-beige/70 mt-1 text-sm">Access your vendor dashboard</p>
        </div>
        ...
        <div className="bg-white dark:bg-maasai-brown rounded-3xl shadow-2xl border border-maasai-beige/30 dark:border-maasai-brown-light p-8">
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-sm text-maasai-brown/70 dark:text-maasai-beige/70">
              Not a vendor yet?{' '}
              <Link href="/vendor/register" className="text-maasai-red font-semibold hover:underline inline-flex items-center gap-1">
                <Store className="h-3.5 w-3.5" /> Register as vendor
              </Link>
            </p>
            <p className="text-sm">
